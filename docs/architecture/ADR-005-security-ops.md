...
App Check is **off by default** across web clients, SSO, Cloud Functions, and
Pulse AI. Re-enable later with explicit flags after providers and Console
...
- Pulse AI: `PULSE_AI_REQUIRE_APP_CHECK=true`
...
- [ ] When re-enabling: set the four flags above in App Hosting / Functions env
