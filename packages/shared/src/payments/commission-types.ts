...
export const COMMISSION_STREAMS = ["commission", "override"] as const;
export type CommissionStream = (typeof COMMISSION_STREAMS)[number];

export const COMMISSION_TRANSACTION_TYPES = [
  "COMMISSION",
  "OVERRIDE",
  "BONUS",
  "ADJUSTMENT",
...
export type CommissionTransactionType =
  (typeof COMMISSION_TRANSACTION_TYPES)[number];

export const COMMISSION_ISSUE_SEVERITIES = [
  "INFO",
  "WARNING",
  "ERROR",
  "BLOCKING",
] as const;
export type CommissionIssueSeverity =
  (typeof COMMISSION_ISSUE_SEVERITIES)[number];

export type PartyRef =
  | { kind: "agency"; orgNodeId: string }
...
export function emptyCommissionRunTotals(): CommissionRunTotals {
  return {
    receivedCents: 0,
    expectedCents: 0,
    varianceCents: 0,
