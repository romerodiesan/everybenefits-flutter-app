...
export type SsoErrorCode = "appcheck-missing" | "appcheck-invalid" | "rate-limited" | "idToken-required" | "invalid-token" | "code-required" | "invalid-code" | "account-disabled" | "network" | "missing-token" | "unknown";
