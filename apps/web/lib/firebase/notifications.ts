...
import { getFirebaseApp, getFirebaseDb } from "@pulse/firebase-client";
import {
  callCloudFunction,
...
export function channelForType(type: string): NotificationChannelFilter {
  ...
  if (type === "admin_broadcast" || type === "registration_pending") {
    return "all";
  }
  return "all";
}
...
function stateFrom(
  ...
  return {
    ...
    prefs: {
      ...
      pushAdmin: prefsRaw.pushAdmin !== false,
      ...
      inAppAdmin: prefsRaw.inAppAdmin !== false,
    },
  };
}
