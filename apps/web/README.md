...
1. **Authentication → Settings → Authorized domains**: add `localhost` and production hosts (`pulse.everybenefits.us`, App Hosting preview domains).
...
Firebase App Hosting (`pulse-web-app`). See [`docs/deploy.md`](../../docs/deploy.md).
