...
export function SettingsNav({
  ...
  return (
    <>
      ...
      <nav
        className="sticky top-0 z-10 -mx-1 flex gap-1.5 overflow-x-auto bg-[var(--mesh-deep)]/95 px-1 pb-2 pt-1 backdrop-blur-md lg:hidden"
...
export function SettingsRow({
  ...
  return (
    <div className="flex flex-col gap-2 py-3 first:pt-0 last:pb-0 sm:flex-row sm:items-start sm:justify-between sm:gap-4">
      ...
      <div className="min-w-0 sm:max-w-[60%] sm:shrink-0">{children}</div>
    </div>
  );
}
