...
import { Avatar, Badge, Button } from "@pulse/ui";
import {
  SettingsNav,
...
export function ProfilePage() {
  ...
  return (
    <div className="mx-auto w-full max-w-6xl px-3 pb-8 pt-3 sm:px-4 lg:px-8 lg:pt-8">
      <header className="mb-4 border-b border-glass-border pb-3 sm:mb-5 sm:pb-4">
      ...
      <div className="grid gap-4 lg:grid-cols-[260px_minmax(0,1fr)] lg:gap-5 xl:grid-cols-[280px_minmax(0,1fr)]">
        <aside className="space-y-3 lg:sticky lg:top-6 lg:space-y-4 lg:self-start">
          <div className="pulse-sheet p-3 sm:p-4">
