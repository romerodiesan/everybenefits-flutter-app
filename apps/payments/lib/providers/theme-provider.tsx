...
/** Persist to Firestore so other Pulse apps pick up the same appearance. */
...
/**
 * Payments inherits appearance from Pulse via shared localStorage keys and
 * Firestore `users/{uid}.appearance`, and can write changes back.
 */
